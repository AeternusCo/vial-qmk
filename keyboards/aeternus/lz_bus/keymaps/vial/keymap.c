...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        MO(_FN), KC_LALT, KC_TRNS, KC_LGUI,KC_SPC, KC_ENT, KC_TRNS, MO(_FN), TT(_NAV), MO(_NAV)
    ),
    [_FN] = LAYOUT(
    ...
    [_NAV] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(_BASE), KC_TRNS
    )
};
